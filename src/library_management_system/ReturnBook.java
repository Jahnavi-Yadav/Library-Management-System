...
public class ReturnBook extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
		...
		ResultSet rs = st.executeQuery();
                ...
                while (rs.next()) {
                    textField_2.setText(rs.getString("book_name"));
                    textField_3.setText(rs.getString("student_name"));
		...
		rs.close();
            ...
            if(ae.getSource() == b2){
                String sql = "INSERT INTO returnbook(book_id, student_id, book_name, student_name,course, branch, dateofissue, dateofreturn) VALUES(?, ?, ?, ?, ?, ?, ?, ?)";
		PreparedStatement st = con.c.prepareStatement(sql);
		st.setString(1, textField.getText());

	...
	private JPanel contentPane;
        ...
        public Aboutus() {
           ...
           // l1 = new JLabel(i3);
            ...
            JLabel l6 = new JLabel("Developed By : Jahnavi,pallavi,Meenakshi,lakshita,Neha and Nehal");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
           // l6.setBounds(70, 198, 600, 35);
            contentPane.add(l6);

            JLabel l7 = new JLabel("for any queries regarding the project you may cocntact us");
